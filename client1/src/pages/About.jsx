...
const About = () => {
  ...
  return (
   <div className=''> 
    <div className='ml-55 mt-20 text-6xl font-bold bg-gradient-to-r from-[#3b3bca] via-purple-500 to-pink-500 text-transparent bg-clip-text animate-bounce'>Hello, {user.username}</div>
     <div className='flex flex-row flex-1 p-[20px]'>
       
       <div className='w-[50%] ml-50  mr-30'> 
           <h1 className='text-5xl font-bold mt-3 mb-5'>Why Choose Us?</h1>
